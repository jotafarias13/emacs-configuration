...
Para utilizar ambientes virtual (virtual environments) em python, é necessário instalar o [[https://virtualenv.pypa.io/en/latest/installation.html][virtualenv]]. O pacote /[[https://github.com/jorgenschaefer/pyvenv][pyvenv]]/ possibilita utilizar o virtual environment dentro do Emacs.
...
Para padronizar códigos, é necessário utilizar um checador. O pacote /[[https://www.flycheck.org/][flycheck]]/ checa o código de acordo com alguns possíveis checkers. Preferencialmente, utilzar /[[https://flake8.pycqa.org/][flake8]]/ seguido de /[[https://docs.pylint.org/][pylint]]/.
...
Para facilitar o término de workflow, as funções abaixo fecham o buffer de processo de Python (e, assim, terminando o processo) e desativam quaisquer ambientes virtuais abertos.
...
Para autoformatação de código, black e isort são usados. O pacote blacken usa black para reformatar o código sem alterar a ordem e o pacote python-isort usa o isort para ajeitar a ordem dos imports. É necessário ter ambos instalados no computador ou ambiente virtual.
